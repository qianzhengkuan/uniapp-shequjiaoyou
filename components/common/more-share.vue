<template>
	<uni-popup ref="popup" type="bottom">
		...
		<view class="flex align-center">
			<view class="flex-1 flex flex-column align-center justify-center py-2" v-for="(item,index) in List" :key="index" hover-class="bg-light" @tap="share(item)">
				<view class="iconfont text-white flex align-center justify-center font-lg rounded-circle" :class="item.icon"
					:style="item.color" style="width: 100rpx;height: 100rpx;"></view>
